...
*                            LZW Decompression                              *
*                                                                           *
*         adapted for Delphi Version 7 (32 bit) by S.Fabricius              *
****************************************************************************}
...
{------------------------------------------------------------------------------
 ...
 Description:
    ...
    - inStr: is a Stream that contains the complete LZW Data including the Magic header.
    ...
    - dstFile: is the Filename where the decompressed data have to be stored.
     

 Published by S. Fabricius, 
 mailto: mr_sven@web.de if you find errors in this file.
